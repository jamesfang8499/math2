...
\subsection*{习题6.1}\addcontentsline{toc}{subsection}{习题6.1}
\begin{enumerate}
...
\subsection*{习题6.2}\addcontentsline{toc}{subsection}{习题6.2}
\begin{enumerate}
...
\subsection*{习题6.3}\addcontentsline{toc}{subsection}{习题6.3}
\begin{enumerate}
...
\section*{复习题六}\addcontentsline{toc}{section}{复习题六}
\begin{enumerate}
    \item 用作图法求锐角$x$.
\begin{multicols}{2}
    \begin{enumerate}
