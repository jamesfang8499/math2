...
\begin{figure}[htp]\centering
    ...
    \centering
   	...
   	\draw (-0.5, 0) -- (-0.0625, 3) coordinate[pos=0] (l1)
   	coordinate[pos=0.16] (l2)
   	coordinate[pos=0.32] (l3)
   	coordinate[pos=0.48] (l4)
   	coordinate[pos=0.64] (l5)
   	coordinate[pos=0.80] (l6)
   	coordinate[pos=1.0] (l7);
   	\draw (0.5, 0) -- (	0.0625, 3) coordinate[pos=0] (r1)
   	coordinate[pos=0.16] (r2)
   	coordinate[pos=0.32] (r3)
   	coordinate[pos=0.48] (r4)
   	coordinate[pos=0.64] (r5)
   	coordinate[pos=0.80] (r6)
   	coordinate[pos=1.0] (r7);
   	\foreach \i in {1,...,6} {
   	...
   	\node[label=above:$A$,inner sep=0,outer sep=0] (A) at (0,3) {};
   	\node[label=below:$B$,inner sep=0,outer sep=0] (B) at (0,0) {};
   	\node[label=below:$D$,inner sep=0,outer sep=0] (D) at (3.8,0) {};
   	\coordinate (E) at (0,0.48);
   	\node[below left,fill=white,inner sep=0,outer sep=0] at (E) {$E$};
   	\draw ($(D)-(0.05,0)$) rectangle ($(D)+(0.05,0.48)$);
   	\coordinate (C) at ($(D)+(0.15,0.48)$);
   	\draw[dashed] (E)--(C);
   	\node[right] at (C) {$C$};
   	\draw (A)--(C);
   	\node at ($(C)+(-0.8,0.24)$) {$\alpha$};
   	\draw[fill=white] (C) arc (-32.211:-200:0.2) -- ++(-0.1,0.063) -- ++(0.0251,0.035) -- cycle;
    \end{tikzpicture}
    \caption{}
    \end{minipage}
    \begin{minipage}[t]{0.48\textwidth}
...
\begin{figure}[htp]\centering
    ...
    \centering
	\begin{tikzpicture}[scale=1]
	\draw (-0.5, 0) -- (-0.0625, 4) coordinate[pos=0] (l1)
	coordinate[pos=0.125] (l2)
	coordinate[pos=0.250] (l3)
	coordinate[pos=0.375] (l4)
	coordinate[pos=0.500] (l5)
	coordinate[pos=0.625] (l6)
	coordinate[pos=0.750] (l7)
	coordinate[pos=0.875] (l8)
	coordinate[pos=1.0] (l9);
	\draw (0.5, 0) -- (	0.0625, 4) coordinate[pos=0] (r1)
	coordinate[pos=0.125] (r2)
	coordinate[pos=0.250] (r3)
	coordinate[pos=0.375] (r4)
	coordinate[pos=0.500] (r5)
	coordinate[pos=0.625] (r6)
	coordinate[pos=0.750] (r7)
	coordinate[pos=0.875] (r8)
	coordinate[pos=1.0] (r9);
	\foreach \i in {1,...,8} {
		\pgfmathsetmacro{\j}{\i + 1} 
		\draw (l\i)--(r\i);
		\draw (l\i)--(r\j);
	...
	\node[label=above:$A$,inner sep=0,outer sep=0] (A) at (0,4) {};
	\node[label=below:$B$,inner sep=0,outer sep=0] (B) at (0,0) {};
	\node[label=below:$C$,inner sep=0,outer sep=0] (C) at (3.8,0) {};
	\node[label=below:$D$,inner sep=0,outer sep=0] (D) at (5.3,0) {};
	\coordinate (E) at (0,1);
	\node[below left,fill=white,inner sep=0,outer sep=0] at (E) {$E$};
	\draw ($(C)-(0.05,0)$) rectangle ($(C)+(0.05,1)$);
	\coordinate (C') at ($(C)+(0.15,1)$);
	\draw[dashed] (E)--(C');
	\node[right,above] at (C') {$C'$};
	\draw (A)--(C');
	\node at ($(C')+(-0.8,0.24)$) {$\alpha$};
	\draw[fill=white] (C') arc (-38.2902:-200:0.2) -- ++(-0.1,0.0789) -- ++(0.03,0.038) -- cycle;
	\draw ($(C')-(0.65,0)$) arc (180:141.71:0.65);
	
	\draw ($(D)-(0.05,0)$) rectangle ($(D)+(0.05,1)$);
	\coordinate (D') at ($(D)+(0.15,1)$);
	\draw[dashed] (E)--(D');
	\node[right,above] at (D') {$D'$};
	\draw (A)--(D');
	\node at ($(D')+(-0.8,0.2)$) {$\beta$};
	\draw[fill=white] (D') arc (-29.5115:-191:0.2) -- ++(-0.1,0.0566) -- ++(0.028,0.0494667) -- cycle;
	\draw ($(D')-(0.65,0)$) arc (180:150.489:0.65);
	\end{tikzpicture}
    \caption{}
    \end{minipage}
    \begin{minipage}[t]{0.48\textwidth}
...
\begin{figure}[htp]\centering
    \begin{minipage}[t]{0.3\textwidth}
		...
		\begin{tikzpicture}[scale=1]
			...
			\draw[name path=upper,gray!30,smooth,domain=-1:2] plot (\x,rand*0.2+1.9);	
			\draw[name path=lower,gray!30,smooth,domain=-1:2] plot (\x,rand*0.2+0.4);	
			\tikzfillbetween[of=upper and lower]{gray!30};
			\tkzDefPoint[label=above:$C$](1.5,2.41925){C}
			\tkzDefPoint[label=below:$B$](1.5,0){B}
    ...
    \centering
    \begin{tikzpicture}[scale=1]
    	\tikzset{trees/.style={postaction={decorate,
    				decoration={markings,% switch on markings 
    					mark=% actually add a mark
    					between positions 0 and 1 step 0.9999/#1
    					with
    					{
    						\draw (0,0)--(0,0.07)--(-0.05,0.15) 
    						(0,0.1)--(0.05,0.15);
    					}
    	}}}}
    	\draw[trees=20] (2, 7) to[out=45, in=-120] (3, 8) to[out=60, in=-120] (3.5,8.7) to[out=60,in=180] (4, 9) to[out=0, in=135] (5, 8);
    	\tkzDefPoint[label=below:$C$](4,7){C}
    	\tkzDefPoint[label=above:$D$](4,9){D}
    	\tkzDefPoint[label=below:$A$](-2.47214,7){A}
    	\tkzDefPoint[label=below:$B$](-1.11861,7){B}
    	\tkzDefPoint(-1.5,9){E}
    	\tkzDrawSegment(C,D)
    	\tkzDrawSegments[dashed](A,D B,D E,D)
    	\draw ($(A)-(0.5,0)$)--(5,7);
    	\tkzMarkAngle[size=0.7](E,D,A)
    	\tkzMarkAngle[size=1.5](E,D,B)
    	\tkzLabelAngle[pos=1](E,D,A) {$18^\circ$}
    	\tkzLabelAngle[pos=1.8](E,D,B) {$23^\circ$}
    \end{tikzpicture}
    \caption*{第4题}
    \end{minipage}
    \end{figure}
...
\begin{figure}[htp]
	...
	\draw[dashed] (1.5,2.598)--(-1.5,-2.598);
	\draw (0.75,1.299) circle (0.2);
	\node at (0.75,0.9) {太阳};
	\draw (-1.5,-2.598) circle (0.09);
	\node at (-1.5,-2.9) {地球};
	\draw (12,-1) circle (0.09);
	\draw[dashed] (1.5,2.598)--(12,-1)--(-1.5,-2.598);
	\node at (1.5,3) { };
	\end{tikzpicture}}    
\caption{}
\end{figure}
...
%    \resizebox{\columnwidth}{!}{
	\begin{tikzpicture}
		\pgfmathsetseed{10020}
		\draw[name path=upper,gray!30,smooth,domain=-1:4] plot (\x,rand*0.2+1.5);	
		\draw[name path=lower,gray!30,smooth,domain=-1:4] plot (\x,rand*0.2+0.2);	
		\tikzfillbetween[of=upper and lower]{gray!30};
		\tkzDefPoints{0/0/C,3/-0.5/A,2.76/1.97/B};
		\tkzDrawSegment(A,C)
    ...
    \centering
	\begin{tikzpicture}[>=latex, scale=1.2]
	\tkzDefPoints{0/0/A', 2/0/B', 0.272748/-1.77947/C, -0.5/0/A, 3/0/B}
...
\begin{figure}[htp]
	...
	\begin{tikzpicture}[scale=1]
	\pgfmathsetseed{10020}
	\draw[name path=upper,gray!30,smooth,domain=-2:6] plot (\x,rand*0.2+2-\x/10);	
	\draw[name path=lower,gray!30,smooth,domain=-1:7] plot (\x,rand*0.2-\x/10);	
	\tikzfillbetween[of=upper and lower]{gray!30};
	\tkzDefPoint(0, 2.5){B}
	\tkzDefPoint(0, 5.5){A}
	\tkzDefPoint(2, -1){C}
	...
	\tkzLabelAngle[pos=1.2](A,C,B){$\alpha$}
	\tkzMarkAngle[size=0.5](D,C,B)
	\tkzLabelAngle[pos=0.7](D,C,B){$\beta$}
	\tkzMarkAngle[size=0.5](B,D,C)
	\tkzLabelAngle[pos=0.7](B,D,C){$\gamma$}
	\node at (3.25,-1.2) {$a$};
	\end{tikzpicture}
    \caption*{第14题}
\end{figure}
