...
\subsection*{习题4.1}\addcontentsline{toc}{subsection}{习题4.1}
\begin{enumerate}
...
\subsection*{习题4.2}\addcontentsline{toc}{subsection}{习题4.2}
\begin{enumerate}
...
\subsection{习题4.3}\addcontentsline{toc}{subsection}{习题4.3}
\begin{enumerate}
...
\subsection*{习题4.4}\addcontentsline{toc}{subsection}{习题4.4}
\begin{enumerate}
    \item 求作已知圆的外切正六边形．
...
\section*{复习题四}\addcontentsline{toc}{section}{复习题四}
\begin{enumerate}
